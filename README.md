...
```
              ...
              ┌─────────────────┘             └──────────────────┐
              │                                                    │
   GIGA (192.168.200.163)                        miniboss (192.168.200.213)
   ...
   MECHA (192.168.200.87) ──── NFS client ──── mounts /opt/swarm/
...
| `nfs.primary` | `192.168.200.163:/opt/swarm` | NFS primary export |
| `nfs.replica` | `192.168.200.213:/opt/swarm-replica` | Replica for HA |
